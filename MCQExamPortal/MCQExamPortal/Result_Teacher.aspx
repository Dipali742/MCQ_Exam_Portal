<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Result_Teacher.aspx.cs" Inherits="Bin_Result_Teacher" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="SlateBlue" Font-Bold="True" ForeColor="White" Height="80px" Width="100%" Font-Size="Large">
            <center><asp:Label ID="Label2" runat="server" Text="Student Result" Font-Bold="True" Font-Size="XX-Large" ForeColor="White"></asp:Label></center>
            </asp:Panel>
        <div>
