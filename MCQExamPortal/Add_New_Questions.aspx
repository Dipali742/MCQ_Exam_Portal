<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add_New_Questions.aspx.cs" Inherits="Add_New_Questions" %>
        ...
        <div>
            <asp:Panel ID="Panel1" runat="server" BackColor="Slateblue" BorderStyle="None" Height="100" server="" Width="100%">
             <center><asp:Label ID="Label1" runat="server" Text="Online Examination System" ForeColor="White" Font-Size="XX-Large" Height="50" Width="100%"></asp:Label>
                </center> <center><asp:Label runat="server" Text="Add Questions to Current Quiz" Font-Size="X-Large" ForeColor="White"></asp:Label></center></asp:Panel>
            <br />
             <center>
            <table>
